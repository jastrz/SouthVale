    ...
    private static GameConfigDto BuildConfig()
    {
        var buildings = BuildingConfig.Levels.ToDictionary(
            ...
            b => b.Value.Select(l => new BuildingLevelConfigDto(
                l.Level,
                new ResourcesDto((int)l.UpgradeCost.Wood, (int)l.UpgradeCost.Clay, (int)l.UpgradeCost.Iron, (int)l.UpgradeCost.Crop),
                l.UpgradeTime,
                ...
                l.Effects.ProductionPerHour.IsEmpty() ? null : new ResourcesDto(
                    ...
                    (int)l.Effects.ProductionPerHour.Crop
                ),
        ...
        var troops = TroopsConfig.All.ToDictionary(
            ...
            t => new TroopConfigDto(
                t.Key.ToString(),
                new ResourcesDto((int)t.Value.TrainingCost.Wood, (int)t.Value.TrainingCost.Clay, (int)t.Value.TrainingCost.Iron, (int)t.Value.TrainingCost.Crop),
