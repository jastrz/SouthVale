        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BotPersonality = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Wood = table.Column<double>(type: "double precision", nullable: false),
                    Clay = table.Column<double>(type: "double precision", nullable: false),
                    Iron = table.Column<double>(type: "double precision", nullable: false),
                    Beer = table.Column<double>(type: "double precision", nullable: false),
                    Troops_Counts = table.Column<string>(type: "jsonb", nullable: false),
                    LastTickAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PlayerId = table.Column<Guid>(type: "uuid", nullable: false),
                    LastAttackAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CompletesAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    TimePerUnit = table.Column<TimeSpan>(type: "interval", nullable: false),
                    VillageId = table.Column<Guid>(type: "uuid", nullable: false),
                    JobId = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarriedResources_Beer = table.Column<double>(type: "double precision", nullable: true),
